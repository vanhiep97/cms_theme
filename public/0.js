...
/* harmony import */ var _plugins_vee_validate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../plugins/vee-validate */ "./resources/js/plugins/vee-validate.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapState"])("lang", {
  ...
  methods: {
    changeLanguage: function changeLanguage(locale) {
      if (this.$i18n.locale !== locale) {
        var localeSelect = this.locales.filter(function (item) {
        ...
        Object(_plugins_vee_validate__WEBPACK_IMPORTED_MODULE_2__["loadVeeValidate"])(locale);
  ...
  return _c("div", { attrs: { id: "home" } }, [
    _c(
      ...
      [
        _c(
          "b-form-group",
          { attrs: { label: _vm.$t("commons.label.change_language") } },
          [
            _c(
              "b-form-radio-group",
              {
                ...
                on: { input: _vm.changeLanguage }
              },
              _vm._l(_vm.locales, function(locale, key) {
                return _c(
                  "b-form-radio",
                  { key: key, attrs: { value: locale.text } },
                  [
                    _vm._v(
                      "\n                " +
                        _vm._s(_vm.$t("commons.locale." + locale.text)) +
                        "\n            "
                    )
                  ]
                )
